...
const packageGroupsRoutes = require('./package-groups')
const packageOrdersRoutes = require('./package-orders')
...
router.use('/packages', adminAuthenticate, packagesRoutes)
router.use('/package-groups', adminAuthenticate, packageGroupsRoutes)
router.use('/package-orders', adminAuthenticate, packageOrdersRoutes)
