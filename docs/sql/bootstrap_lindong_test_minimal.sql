-- lindong_test 最小测试环境初始化 SQL
-- 目标：
-- 1. 让小程序测试环境可以完成静默登录
-- 2. 让首页 banner / 课包列表 / 课包详情可以正常返回
-- 3. 为后续开团/参团/下单链路准备基础表
--
-- 使用方式：
-- 1. 先确保当前数据库是 lindong_test
-- 2. 直接整段执行
-- 3. 执行后重启/更新 lindong-api-test 服务，再重新打开微信开发者工具
...
INSERT INTO users (
  id, openid, nickname, avatar_url, phone, created_at, updated_at
) VALUES
  (
    'user_test_001',
    'seed_test_openid_001',
    '测试家长A',
    'https://dummyimage.com/120x120/e8f8f9/1abcc5.png&text=A',
    '13800000001',
    '2026-06-01 10:00:00',
    '2026-06-01 10:00:00'
  ),
  (
    'user_test_002',
    'seed_test_openid_002',
    '测试家长B',
    'https://dummyimage.com/120x120/fbead9/ff7a00.png&text=B',
    '13800000002',
    '2026-06-01 10:05:00',
    '2026-06-01 10:05:00'
  );
...
INSERT INTO user_identities (
  id, user_id, identity_type, identity_key, created_at, updated_at, last_used_at
) VALUES
  (
    'identity_test_u01',
    'user_test_001',
...
INSERT INTO mini_program_banners (
  id, image_url, title, jump_type, jump_target, sort, online_time, offline_time, status, created_at, updated_at
) VALUES
  (
    'banner_test_001',
    'https://dummyimage.com/1200x420/f6ead3/b9832f.png&text=PACKAGE+HOME',
    '首页主 Banner',
    'none',
    '',
    10,
  ...
  (
    'banner_test_002',
    'https://dummyimage.com/1200x420/e7f8ef/1f9d63.png&text=TRIAL+PACKAGE',
    '体验课 Banner',
    'none',
    '',
    20,
...
INSERT INTO course_packages (
  ...
  (
    'pkg_test_001',
    '[测试] 少儿体适能 体验课',
    'https://dummyimage.com/960x540/e8f1ff/235784.png&text=Trial+Package',
    'https://dummyimage.com/960x540/d9ecff/235784.png&text=Share+Cover',
    JSON_ARRAY(
      'https://dummyimage.com/1280x720/e8f1ff/235784.png&text=Trial+01',
      'https://dummyimage.com/1280x720/d9ecff/235784.png&text=Trial+02'
    ),
    9900,
    '体验课',
    '4-6岁',
    ...
    '2,3,4',
    JSON_ARRAY(
      JSON_OBJECT('target_count', 2, 'price_fen', 4900),
      JSON_OBJECT('target_count', 3, 'price_fen', 3900),
      JSON_OBJECT('target_count', 4, 'price_fen', 3500)
    ),
    '南山区',
    '桃源社区',
    '邻动体适能训练点',
    ...
    '王教练',
    '专注少儿体适能与动作启蒙。',
    JSON_ARRAY('https://dummyimage.com/800x1200/f3f4f6/374151.png&text=Coach+Cert+A'),
    '<p>用于测试环境的体验课详情内容。</p>',
    48,
    '2026-01-01 10:00:00',
    '2027-12-31 23:59:59',
  ...
  (
    'pkg_test_002',
    '[测试] 少儿跳绳基础课',
    'https://dummyimage.com/960x540/fff4d8/c79200.png&text=Jump+Rope',
    '',
    JSON_ARRAY(
      'https://dummyimage.com/1280x720/fff4d8/c79200.png&text=Jump+01'
    ),
    19900,
    '跳绳',
    '5-8岁',
    ...
    '2,4',
    JSON_ARRAY(
      JSON_OBJECT('target_count', 2, 'price_fen', 9900),
      JSON_OBJECT('target_count', 4, 'price_fen', 5900)
    ),
    '福田区',
    '香蜜湖社区',
    '香蜜体育公园',
    ...
    '李教练',
    '专注跳绳基础动作与节奏训练。',
    JSON_ARRAY('https://dummyimage.com/800x1200/f3f4f6/374151.png&text=Coach+Cert+B'),
    '<p>用于测试环境的跳绳课详情内容。</p>',
    72,
    '2026-01-05 10:00:00',
    '2027-12-31 23:59:59',
  ...
  (
    'pkg_test_003',
    '[测试] 少儿体适能进阶课',
    'https://dummyimage.com/960x540/e7f8ef/1f9d63.png&text=Fitness+Advanced',
    '',
    JSON_ARRAY(
      'https://dummyimage.com/1280x720/e7f8ef/1f9d63.png&text=Fitness+01'
    ),
    29900,
    '体适能',
    '6-9岁',
    ...
    '3,5',
    JSON_ARRAY(
      JSON_OBJECT('target_count', 3, 'price_fen', 10900),
      JSON_OBJECT('target_count', 5, 'price_fen', 7900)
    ),
    '宝安区',
    '新安社区',
    '宝安青少年活动中心',
    ...
    '陈教练',
    '进阶体能与团队协作训练。',
    JSON_ARRAY('https://dummyimage.com/800x1200/f3f4f6/374151.png&text=Coach+Cert+C'),
    '<p>用于测试环境的进阶课详情内容。</p>',
    96,
    '2026-01-10 10:00:00',
    '2027-12-31 23:59:59',
...
INSERT INTO biz_serial_counters (
  biz_type, biz_date, current_seq, created_at, updated_at
) VALUES
